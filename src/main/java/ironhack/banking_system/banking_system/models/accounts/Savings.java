...
public class Savings extends Account {
    ...
    public Savings(BigDecimal minimumBalance, BigDecimal interestRate, LocalDate lastInterestDate) {
        this.minimumBalance = minimumBalance;
        this.savingInterestRate = interestRate;
        this.lastInterestDate = lastInterestDate;
    }

    public Savings(Money balance, AccountHolder primaryOwner, Money penaltyFee, LocalDate creationDate, AccountStatus accountStatus, BigDecimal minimumBalance, BigDecimal interestRate, LocalDate lastInterestDate) {
        super(balance, primaryOwner, penaltyFee, creationDate, accountStatus);
        this.minimumBalance = minimumBalance;
        this.savingInterestRate = interestRate;
        this.lastInterestDate = lastInterestDate;
    ...
    public Savings(AccountHolder secondaryOwner, BigDecimal minimumBalance, BigDecimal savingInterestRate, LocalDate lastInterestDate) {
